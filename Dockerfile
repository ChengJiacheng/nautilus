...
# RUN git config --global user.name "ChengJiacheng" && git config --global user.email "chinging@foxmail.com" && config --global credential.helper cache && git config --global credential.helper 'cache --timeout=3600'